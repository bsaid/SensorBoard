...
{
    return spi.write(WriteAddr, 1, WriteData);
}
...
{
    spi.read(ReadAddr, Bytes, ReadBuf);
}
...
//for(int a=0;a<21;a++) printf("%x", response[a]); printf("\n");

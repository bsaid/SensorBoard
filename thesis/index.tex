...
These devices usually cover their use cases and don't have any additional features like power independence, enough logging memory or openness for user code. The remaining hardware that fulfills all the conditions above is usually expensive.
...
For outdoor testing of the device, I have selected a task about movement analysis of a horse. I placed the devices on the horse's body as wearable devices, and I was developing algorithms for determination of the type of its movement -- stand, walk, trot or gallop.
...
\usepackage{gensymb}
\usepackage{multicol}
\usepackage[acronym,toc]{glossaries}  %% Acronyms

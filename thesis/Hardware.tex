...
//todo: By the analysis of additional costs I mean the counting of the prices of all parts that were finally spare or weren't finally used. The table \ref{tab:additionalCost} counts all parts of the SensorBoards and their prices. The green values are prices of parts that were finally used. The "Total used" amount means the price of all parts at one piece that were used during any use case.
...
\begin{table}[H]
	...
	\begin{tcolorbox}[tab2,tabularx={|X|l|c|c|},title=Additional cost calculation]
		...
		PCB & \$ 23 & \greenYes & \greenYes \\
		SMT job & \$ 65 & \greenYes & \greenYes \\ \hline\hline
		...
		\greenCell{\textbf{Total used and necessary}} & \greenCell{\textbf{\$ //todo}} & \greenYes & \greenYes \\
		\yellowCell{\textbf{Total used and unnecessary}} & \yellowCell{\textbf{\$ //todo}} & \yellowCell{Yes} & \yellowCell{No} \\
		\redCell{\textbf{Total unused}} & \redCell{\textbf{\$ //todo}} & \redNo & \redNo \\
	\end{tcolorbox}
\end{table}
